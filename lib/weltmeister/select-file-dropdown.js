...
wm.SelectFileDropdown = ig.Class.extend({
	...
	show: function( event ) {
		var inputPos = { top: this.input.offsetLeft, left: this.input.offsetTop };//this.input.getPosition(this.input.getOffsetParent());
		var inputHeight = this.input.clientHeight + parseInt(this.input.style.marginTop);
